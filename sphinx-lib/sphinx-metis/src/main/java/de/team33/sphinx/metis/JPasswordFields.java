...
public final class JPasswordFields {
     ...
     */
    public static <T extends JPasswordField> Charger<T> charger(final T target) {
        return new Charger<>(target, Charger.class);
    }

    /**
     * Returns a new {@link Setup} for a given {@link JPasswordField} instance.
     */
    public static Setup<JPasswordField, ?> setup(final JPasswordField target) {
    ...
    /**
     * Charger implementation to charge target instances of {@link JPasswordField}.
     * 
     * @param <T> The final type of the target instance, at least {@link JPasswordField}.
     */
    public static final class Charger<T extends JPasswordField>
