...
class ChannelItem {
    ...
    ChannelItem(final Method addListenerMethod, final Method listenerMethod) {
        ...
        this.removeListenerMethodName = addListenerMethodName.replace("add", "remove");
