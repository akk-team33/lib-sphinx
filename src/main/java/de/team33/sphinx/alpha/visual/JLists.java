...
public final class JLists {
     ...
     */
    public static Builder<JList, ?> builder() {
        return new Builder<>(JList::new, Builder.class);
    }
     ...
     */
    public static <T extends JList> Builder<T, ?> builder(final Supplier<T> newTarget) {
     ...
     */
    public static class Builder<T extends JList, B extends Builder<T, B>>
     ...
     */
    public interface Setup<T extends JList, S extends Setup<T, S>> extends JComponents.Setup<T, S> {

        /**
         * @see JList#setModel(ListModel)
         */
        default S setModel(final ListModel arg0) {
         ...
         */
        default S setPrototypeCellValue(final Object arg0) {
         ...
         */
        default S setCellRenderer(final ListCellRenderer arg0) {
         ...
         */
        default S setListData(final Object[] arg0) {
         ...
         */
        default S setListData(final Vector arg0) {
            return setup(result -> result.setListData(arg0));
        }
